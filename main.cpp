...
/*
    Планы на ближайшее время:
        - Подключить сокет, который будет дергать контроллеры (этот пункт нуждается в подпунктах)
        - Исправить модель юзера, чтобы убрать зависимость, для подсчета слов можно использовать
   GamesRepo
        - Добавить в контроллер историю игр
*/
